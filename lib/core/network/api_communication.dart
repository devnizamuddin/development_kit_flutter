...
import '../core/enums/mime_type.dart';
import '../core/extension/file_path.dart';
import '../core/extension/nullable_int_extension.dart';
...
class ApiCommunication {
  ...
  ApiCommunication initialize({required String baseUrl}) {
    _dio = dio.Dio();
    addInterceptor();
